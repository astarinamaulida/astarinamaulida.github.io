const about = {
  ...
  description:
    'I am new in the web development world. I have been working as a Software Engineer since December 2021. My main programming language is javascript with React as the library. However, I keep learning new stuff every day from typescript, gatsby, C# and plan to learn React Native.',
  description2:
