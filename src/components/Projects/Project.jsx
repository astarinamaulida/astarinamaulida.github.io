        ...
        >
          <div className="row">
            ...
            <div className="project-frame">
              ...
              <h3 className="projects-desc">Description</h3>
              <p className="desc">
                PayKids is a multi-page React application, that allows children
                to customise their own virtual debit cards and bank account user
                interface.
              </p>
              <span>
                <a href="https://github.com/astarinamaulida/paykids">
            ...
            <div className="project-frame">
              ...
              <h3 className="projects-desc">Description</h3>
              <p className="desc">
                Cravings is a food pick-up ordering website for a cakery shop.
                The app uses Twilio as our API to implement SMS communication
                from the website to customers and the cakery shop.
              </p>
              <span>
                <a href="https://github.com/astarinamaulida/cravings">
                  <img
          ...
          <div className="row">
            <div className="project-frame">
              ...
              <p className="desc">
                ...
                built for each components and the app is tested by using Jest
                for its unit testing. Cypress is used for automated testing.
              </p>
              <span>
                <a href="https://github.com/astarinamaulida/scheduler">
                  <img
